 ...
 *
 * חומרה — ידית ופס לד — יושבת מעל החזית מאותה סיבה בדיוק: המרחק
 * נמדד בראש הלוח, וידית קצרה באמצע הדלת "רחוקה" מהדלת הגבוהה
 * שהיא מונחת עליה, ובלי שכבה משלה היא נעלמת מאחוריה.
 */
