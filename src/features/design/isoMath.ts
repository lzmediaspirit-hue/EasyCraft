 ...
 */
export const L_FACE = { body: 0, inside: 0, front: 1, hardware: 2, top: 3 };
/*
 * חומרה — ידית ופס לד — יושבת מעל החזית תמיד.
 * המרחק לבדו לא מספיק לה: הוא נמדד בראש הלוח, וידית קצרה באמצע
 * הדלת "רחוקה" מהדלת הגבוהה שהיא מונחת עליה. שכבה משלה היא מה
 * שמחזיק אותה במקום שבו היא באמת נמצאת — על החזית ולא מאחוריה.
 */
/*
 ...
 */
export const L_AWAY = { body: 1, inside: 1, front: 0, hardware: -1, top: 3 };
