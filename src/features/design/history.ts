...
export const history = {
  ...
  /**
   * ביטול המחווה: גם התצלום שנלקח בפתיחתה יורד.
   *
   * מחווה שבוטלה לא שינתה דבר, ולכן אסור שיישאר אחריה צעד ב"בטל".
   * צעד שמחזיר את מה שכבר שם הוא צעד שנראה שבור: הנגר לוחץ "בטל",
   * שום דבר לא זז, והוא לוחץ שוב — ואז נמחק לו השינוי הקודם.
   */
