...
export const SEED_CATALOG: SeedItem[] = [
  ...
  },
  {
    ...
    /*
     * לוח שוכב נמדד בעובי שלו, והגובה מהרצפה הוא `y`.
     *
     * קודם נשמר כאן 750 בשדה הגובה — כלומר, לפי המודל, פלטה
     * בעובי 75 ס״מ שמונחת על הרצפה. זה מה שהגיע לחיתוך ולציור.
     * עכשיו: פלטה בעובי 30 מ״מ שעומדת בגובה 720.
     */
    h: 30,
    d: 500,
    y: 720,
