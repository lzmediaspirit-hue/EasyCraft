 ...
 */
/**
 * הדור של החדרים המובנים.
 *
 * הזריעה רצה פעם אחת, לטבלה ריקה, וזה נכון: מי שמחק חדר לא אמור
 * למצוא אותו שוב בפתיחה הבאה. אבל המשמעות הייתה שחדר מובנה
 * *חדש* לא הגיע לאף התקנה קיימת — מי שהתקין כשהיו ארבעה חדרים
 * נשאר עם ארבעה לתמיד, והארגזים ששויכו לאמבטיה, לחדר ארונות,
 * לחדר ילדים, לכניסה ולמשרד פשוט לא הופיעו בשום רשימה.
 *
 * זו בדיוק התקלה שתוקנה בספריית הארגזים, ולא תוקנה כאן. המספר
 * הזה הוא מה שמפריד בין "נזרע" לבין "מעודכן": כשמוסיפים חדר
 * מובנה — מעלים אותו.
 *
 * 1 — מטבח, סלון, חדר שינה, חדר שירות.
 * 2 — ונוספו אמבטיה, חדר ארונות, חדר ילדים, כניסה לבית, משרד.
 */
...
export const SEED_ROOMS: SeedRoom[] = [
  {
    ...
    icon: 'kitchen',
    groups: ['base', 'upper', 'tall', 'island', 'shelf', 'storage', 'appliance'],
    sortOrder: 10,
    isBuiltin: true,
  },
  {
    ...
    icon: 'living',
    groups: ['base', 'upper', 'tall', 'shelf', 'island', 'storage', 'appliance'],
    sortOrder: 20,
    isBuiltin: true,
  },
  {
    ...
    icon: 'bedroom',
    groups: ['tall', 'base', 'upper', 'shelf', 'storage', 'island', 'appliance'],
    sortOrder: 30,
    isBuiltin: true,
  },
  {
    ...
    icon: 'utility',
    groups: ['base', 'upper', 'tall', 'storage', 'shelf', 'island', 'appliance'],
    sortOrder: 40,
    isBuiltin: true,
  },
  /*
   ...
   */
  {
    ...
    icon: 'bathroom',
    groups: ['base', 'upper', 'tall', 'shelf', 'storage', 'island', 'appliance'],
    sortOrder: 50,
    isBuiltin: true,
  },
  {
...
export const CUSTOM_ROOM_DEF: SeedRoom = {
  ...
  icon: 'custom',
  groups: ['base', 'upper', 'tall', 'storage', 'island', 'shelf', 'appliance'],
  sortOrder: 999,
  isBuiltin: true,
};
