...
export const ROOMS: RoomDef[] = [
  ...
  },
  {
    ...
    icon: 'custom',
    groups: ['base', 'upper', 'tall', 'storage'],
  },
];
...
export const GLYPH_GROUPS_FALLBACK: CatalogGroup[] = ['base', 'upper', 'tall', 'storage'];
