...
export interface StageDef {
  ...
  scheduled?: boolean;
  /** שלב שנסגר מעצמו ברגע שהתהליך נפתח */
  autoDone?: boolean;
}
...
export const STAGES: StageDef[] = [
  {
    ...
    /*
     * נסגר מעצמו במכירה. המנהל שסגר עסקה כבר העביר את ההנחיות —
     * לבקש ממנו ללחוץ "התחלתי" על משהו שהוא בדיוק עשה זו לחיצה
     * שלא אומרת כלום.
     */
    autoDone: true,
  },
  ...
  },
  {
    ...
    label: 'אישור הלקוח',
    /*
     * הלקוח מאשר בעל פה או בהודעה; מי שרושם את זה במערכת הוא
     * המנהל. שלב שמחכה ל"לקוח" לא היה נסגר לעולם.
     */
    role: 'manager',
