...
export interface PlacedUnit extends Entity {
  ...
  drawerBox?: DrawerBox;
  /**
   * כמה הדלת חורגת מהארגז, למעלה ולמטה, במ"מ.
   *
   * דלת אחת יכולה לכסות שני ארגזים שעומדים זה מעל זה, ואז היא
   * שייכת לארגז אחד ומידתה אינה מידתו. שני שדות ולא "גובה דלת"
   * אחד, כי השאלה בשטח היא תמיד לאיזה כיוון היא גדלה: מלמעלה
   * כלפי מעלה, או מלמטה כלפי מטה. ערך שלילי מקצר.
   */
  doorGrowTopMm?: number;
  doorGrowBottomMm?: number;
  /**
