...
export interface PlacedUnit extends Entity {
  ...
  /**
   * כמה הארגז מרוחק מהקיר, במ"מ.
   *
   * ריק או 0 = צמוד לקיר, כמו רוב הארגזים. ערך חיובי מרחיק אותו
   * אל תוך החדר: חצי־אי שיוצא מקצה המטבח, או אי שעומד באמצע.
   * הארגז נשאר שייך לקיר — שם הוא נספר, נמדד ומתומחר — אבל הוא
   * כבר לא נוגע בו.
   */
  offsetMm?: number;
  /**
