 ...
 *
 * ההנחה החליפה רגליים מפורשות בברירת המחדל של הנגרייה, ומכיוון
 * שהגובה השמור הוא גוף ועוד רגליים — היא לא קיצרה את הרגליים אלא
 * האריכה את הגוף. וארגז שנשמר מרחף ירד לרצפה.
 */
...
ok('רגליים מפורשות שורדות את ההנחה', placed.legs.socle === 170, JSON.stringify(placed.legs));
ok('והגוף נשאר 80 ס"מ', placed.legs.body === 800, JSON.stringify(placed.legs));
